const PRACTICE_QUESTIONS = [
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Add format conversion instructions to the system prompt, specifying the expected format for each tool."
      },
      {
        "id": "b",
        "text": "Implement PostToolUse hooks to normalize all tool outputs to consistent formats before the agent processes them."
      },
      {
        "id": "c",
        "text": "Include few-shot examples showing correct interpretation of each format in the system prompt."
      },
      {
        "id": "d",
        "text": "Add a data validation step in the agentic loop that checks format consistency before processing tool results."
      }
    ],
    "correctAnswer": "b",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Check stop_reason === \"end_turn\" to determine loop termination instead of parsing assistant text content."
      },
      {
        "id": "b",
        "text": "Set a higher iteration cap (e.g., 50 iterations) to ensure the loop doesn't stop too early."
      },
      {
        "id": "c",
        "text": "Add more keywords to the termination check, like \"done\", \"finished\", \"completed\"."
      },
      {
        "id": "d",
        "text": "Use a timeout-based approach that terminates the loop after 60 seconds of inactivity."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Have the coordinator emit multiple Task tool calls in a single response to spawn parallel subagents."
      },
      {
        "id": "b",
        "text": "Use async/await in the coordinator's system prompt to request parallel processing."
      },
      {
        "id": "c",
        "text": "Configure a \"parallel\" flag in the AgentDefinition for each subagent."
      },
      {
        "id": "d",
        "text": "Create a separate orchestration layer above the coordinator that manages parallel scheduling."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "The allowedTools list doesn't include \"Task\", which is required for spawning subagents."
      },
      {
        "id": "b",
        "text": "The subagent definitions are missing description fields."
      },
      {
        "id": "c",
        "text": "The coordinator's system prompt doesn't mention subagent capabilities."
      },
      {
        "id": "d",
        "text": "The subagents don't have their own allowedTools configured."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Decompose the request into three distinct items, investigate each in parallel using shared context, then synthesize a unified resolution covering all three."
      },
      {
        "id": "b",
        "text": "Address each issue one at a time in sequence, asking the customer to confirm resolution before moving to the next."
      },
      {
        "id": "c",
        "text": "Prioritize the most urgent issue (billing overcharge) and address the others only if time permits."
      },
      {
        "id": "d",
        "text": "Escalate immediately since multi-concern requests are too complex for automated handling."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Design the coordinator to analyze query requirements and dynamically select which subagents to invoke rather than always routing through the full pipeline."
      },
      {
        "id": "b",
        "text": "Add a timeout that kills subagents if they take too long on simple queries."
      },
      {
        "id": "c",
        "text": "Create a \"fast mode\" and \"thorough mode\" and let users choose."
      },
      {
        "id": "d",
        "text": "Cache results from previous queries to skip subagent calls when possible."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use fork_session to create two independent branches from the shared analysis baseline, each exploring a different approach."
      },
      {
        "id": "b",
        "text": "Continue in the same session, trying one approach, then undoing it and trying the second."
      },
      {
        "id": "c",
        "text": "Start two new sessions, manually copying the key findings into each."
      },
      {
        "id": "d",
        "text": "Use --resume with two different session names pointing to the same base session."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Compile a structured handoff summary including customer ID, root cause, refund amount, actions taken, and recommended next steps."
      },
      {
        "id": "b",
        "text": "Give the human agent access to the full conversation transcript."
      },
      {
        "id": "c",
        "text": "Have the AI agent summarize the conversation in natural language prose before escalating."
      },
      {
        "id": "d",
        "text": "Transfer the entire agent session state to the human agent's interface."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Start a new session with a structured summary of yesterday's key findings, since prior tool results referencing the changed files are now stale."
      },
      {
        "id": "b",
        "text": "Use --resume to continue yesterday's session and inform the agent about the specific files that changed for targeted re-analysis."
      },
      {
        "id": "c",
        "text": "Use --resume and let the agent discover the changes on its own."
      },
      {
        "id": "d",
        "text": "Start completely fresh without any context from yesterday."
      }
    ],
    "correctAnswer": "b",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Re-delegate to search and analysis subagents with targeted queries about economic impact, then re-invoke synthesis with the new findings plus the previous output."
      },
      {
        "id": "b",
        "text": "Ask the synthesis agent to add more content about economic impact from its existing findings."
      },
      {
        "id": "c",
        "text": "Add a note to the final report that economic impact was not fully covered."
      },
      {
        "id": "d",
        "text": "Run the entire research pipeline again with \"economic impact\" added to the original query."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    "id": "q13",
    "scenario": 1,
    "scenarioTitle": "Patient Support Resolution Agent",
    "domain": 1,
    "taskStatement": "1.1",
    "type": "single",
    "difficulty": "medium",
    "question": "Production data shows that in 12% of cases, your agent skips get_patient entirely and calls lookup_prescription using only the patient's stated name, occasionally leading to misidentified accounts and incorrect claim adjustments. What change would most effectively address this reliability issue?",
    "options": [
      {
        "id": "a",
        "text": "Add a programmatic prerequisite that blocks lookup_prescription and process_claim adjustment calls until get_patient has returned a verified patient ID."
      },
      {
        "id": "b",
        "text": "Enhance the system prompt to state that patient verification via get_patient is mandatory before any prescription operations."
      },
      {
        "id": "c",
        "text": "Add few-shot examples showing the agent always calling get_patient first, even when patients volunteer prescription details."
      },
      {
        "id": "d",
        "text": "Implement a routing classifier that analyzes each request and enables only the subset of tools appropriate for that request type."
    ...
    "correctAnswer": "a",
    "explanation": "When a specific tool sequence is required for critical business logic (like verifying patient identity before processing claim adjustments), programmatic enforcement provides deterministic guarantees that prompt-based approaches cannot. Options B and C rely on probabilistic LLM compliance, which is insufficient when errors have financial consequences. Option D addresses tool availability rather than tool prescriptioning, which is not the actual problem.",
    "keyTakeaway": "Use programmatic enforcement (hooks/prerequisites) for critical business rules, not prompt-based guidance."
  },
  {
    "id": "q14",
    "scenario": 1,
    "scenarioTitle": "Client Support Resolution Agent",
    "domain": 1,
    "taskStatement": "1.1",
    "type": "single",
    "difficulty": "medium",
    "question": "Production data shows that in 12% of cases, your agent skips get_client entirely and calls lookup_portfolio using only the client's stated name, occasionally leading to misidentified accounts and incorrect trade reversals. What change would most effectively address this reliability issue?",
    "options": [
      {
        "id": "a",
        "text": "Add a programmatic prerequisite that blocks lookup_portfolio and process_trade reversal calls until get_client has returned a verified client ID."
      },
      {
        "id": "b",
        "text": "Enhance the system prompt to state that client verification via get_client is mandatory before any portfolio operations."
      },
      {
        "id": "c",
        "text": "Add few-shot examples showing the agent always calling get_client first, even when clients volunteer portfolio details."
      },
      {
        "id": "d",
        "text": "Implement a routing classifier that analyzes each request and enables only the subset of tools appropriate for that request type."
    ...
    "correctAnswer": "a",
    "explanation": "When a specific tool sequence is required for critical business logic (like verifying client identity before processing trade reversals), programmatic enforcement provides deterministic guarantees that prompt-based approaches cannot. Options B and C rely on probabilistic LLM compliance, which is insufficient when errors have financial consequences. Option D addresses tool availability rather than tool portfolioing, which is not the actual problem.",
    "keyTakeaway": "Use programmatic enforcement (hooks/prerequisites) for critical business rules, not prompt-based guidance."
  },
  {
    "id": "q15",
    "scenario": 1,
    "scenarioTitle": "Shipper Support Resolution Agent",
    "domain": 1,
    "taskStatement": "1.1",
    "type": "single",
    "difficulty": "medium",
    "question": "Production data shows that in 12% of cases, your agent skips get_shipper entirely and calls lookup_freight using only the shipper's stated name, occasionally leading to misidentified accounts and incorrect reroute fees. What change would most effectively address this reliability issue?",
    "options": [
      {
        "id": "a",
        "text": "Add a programmatic prerequisite that blocks lookup_freight and process_reroute fee calls until get_shipper has returned a verified shipper ID."
      },
      {
        "id": "b",
        "text": "Enhance the system prompt to state that shipper verification via get_shipper is mandatory before any freight operations."
      },
      {
        "id": "c",
        "text": "Add few-shot examples showing the agent always calling get_shipper first, even when shippers volunteer freight details."
      },
      {
        "id": "d",
        "text": "Implement a routing classifier that analyzes each request and enables only the subset of tools appropriate for that request type."
    ...
    "correctAnswer": "a",
    "explanation": "When a specific tool sequence is required for critical business logic (like verifying shipper identity before processing reroute fees), programmatic enforcement provides deterministic guarantees that prompt-based approaches cannot. Options B and C rely on probabilistic LLM compliance, which is insufficient when errors have financial consequences. Option D addresses tool availability rather than tool freighting, which is not the actual problem.",
    "keyTakeaway": "Use programmatic enforcement (hooks/prerequisites) for critical business rules, not prompt-based guidance."
  },
  {
    "id": "q16",
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "Your support agent uses MCP tools that return data in inconsistent formats: get_patient returns Unix timestamps, lookup_prescription returns ISO 8601 dates, and process_claim adjustment returns numeric status codes. The agent occasionally misinterprets these formats, leading to incorrect date comparisons. What's the most reliable approach to fix this?",
    "options": [
      {
        "id": "a",
        "text": "Add format conversion instructions to the system prompt, specifying the expected format for each tool."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "Your support agent uses MCP tools that return data in inconsistent formats: get_client returns Unix timestamps, lookup_portfolio returns ISO 8601 dates, and process_trade reversal returns numeric status codes. The agent occasionally misinterprets these formats, leading to incorrect date comparisons. What's the most reliable approach to fix this?",
    "options": [
      {
        "id": "a",
        "text": "Add format conversion instructions to the system prompt, specifying the expected format for each tool."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "Your support agent uses MCP tools that return data in inconsistent formats: get_shipper returns Unix timestamps, lookup_freight returns ISO 8601 dates, and process_reroute fee returns numeric status codes. The agent occasionally misinterprets these formats, leading to incorrect date comparisons. What's the most reliable approach to fix this?",
    "options": [
      {
        "id": "a",
        "text": "Add format conversion instructions to the system prompt, specifying the expected format for each tool."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "easy",
    "question": "Your agentic loop for the patient support agent sometimes terminates prematurely before completing multi-step resolutions. You're currently using a check that looks for assistant text containing \"resolution complete\" to determine when to stop the loop. What should you change?",
    "options": [
      {
        "id": "a",
        "text": "Check stop_reason === \"end_turn\" to determine loop termination instead of parsing assistant text content."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "easy",
    "question": "Your agentic loop for the client support agent sometimes terminates prematurely before completing multi-step resolutions. You're currently using a check that looks for assistant text containing \"resolution complete\" to determine when to stop the loop. What should you change?",
    "options": [
      {
        "id": "a",
        "text": "Check stop_reason === \"end_turn\" to determine loop termination instead of parsing assistant text content."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "easy",
    "question": "Your agentic loop for the shipper support agent sometimes terminates prematurely before completing multi-step resolutions. You're currently using a check that looks for assistant text containing \"resolution complete\" to determine when to stop the loop. What should you change?",
    "options": [
      {
        "id": "a",
        "text": "Check stop_reason === \"end_turn\" to determine loop termination instead of parsing assistant text content."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A patient contacts your support agent with three issues: a wrong item received, a billing overcharge, and a question about warranty coverage. How should the agent handle this multi-concern request?",
    "options": [
      {
        "id": "a",
        "text": "Decompose the request into three distinct items, investigate each in parallel using shared context, then synthesize a unified resolution covering all three."
      ...
      {
        "id": "b",
        "text": "Address each issue one at a time in sequence, asking the patient to confirm resolution before moving to the next."
      },
      {
        "id": "c",
        "text": "Prioritize the most urgent issue (billing overcharge) and address the others only if time permits."
    ...
    "correctAnswer": "a",
    "explanation": "Multi-concern requests should be decomposed into distinct items, investigated in parallel using shared context, and synthesized into a unified resolution. Sequential handling (B) is unnecessarily slow. Prioritizing one (C) ignores patient concerns. Escalating all multi-concern requests (D) defeats the purpose of automation.",
    "keyTakeaway": "Decompose multi-concern requests → investigate in parallel with shared context → synthesize unified resolution."
  },
  {
    "id": "q32",
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A client contacts your support agent with three issues: a wrong item received, a billing overcharge, and a question about warranty coverage. How should the agent handle this multi-concern request?",
    "options": [
      {
        "id": "a",
        "text": "Decompose the request into three distinct items, investigate each in parallel using shared context, then synthesize a unified resolution covering all three."
      ...
      {
        "id": "b",
        "text": "Address each issue one at a time in sequence, asking the client to confirm resolution before moving to the next."
      },
      {
        "id": "c",
        "text": "Prioritize the most urgent issue (billing overcharge) and address the others only if time permits."
    ...
    "correctAnswer": "a",
    "explanation": "Multi-concern requests should be decomposed into distinct items, investigated in parallel using shared context, and synthesized into a unified resolution. Sequential handling (B) is unnecessarily slow. Prioritizing one (C) ignores client concerns. Escalating all multi-concern requests (D) defeats the purpose of automation.",
    "keyTakeaway": "Decompose multi-concern requests → investigate in parallel with shared context → synthesize unified resolution."
  },
  {
    "id": "q33",
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A shipper contacts your support agent with three issues: a wrong item received, a billing overcharge, and a question about warranty coverage. How should the agent handle this multi-concern request?",
    "options": [
      {
        "id": "a",
        "text": "Decompose the request into three distinct items, investigate each in parallel using shared context, then synthesize a unified resolution covering all three."
      ...
      {
        "id": "b",
        "text": "Address each issue one at a time in sequence, asking the shipper to confirm resolution before moving to the next."
      },
      {
        "id": "c",
        "text": "Prioritize the most urgent issue (billing overcharge) and address the others only if time permits."
    ...
    "correctAnswer": "a",
    "explanation": "Multi-concern requests should be decomposed into distinct items, investigated in parallel using shared context, and synthesized into a unified resolution. Sequential handling (B) is unnecessarily slow. Prioritizing one (C) ignores shipper concerns. Escalating all multi-concern requests (D) defeats the purpose of automation.",
    "keyTakeaway": "Decompose multi-concern requests → investigate in parallel with shared context → synthesize unified resolution."
  },
  {
    "id": "q34",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "When your agent escalates to a human agent, the human agent reports that they lack sufficient context to continue the resolution effectively. They have to re-ask the patient basic questions. What should you implement?",
    "options": [
      {
        "id": "a",
        "text": "Compile a structured handoff summary including patient ID, root cause, claim adjustment amount, actions taken, and recommended next steps."
      },
      {
        "id": "b",
        "text": "Give the human agent access to the full conversation transcript."
    ...
    "correctAnswer": "a",
    "explanation": "Structured handoff summaries provide human agents with the essential information they need in a quickly digestible format. Full transcripts (B) are too verbose to scan quickly. Natural language summaries (C) may miss critical details. Session state transfer (D) is impractical for human agents.",
    "keyTakeaway": "Compile structured handoff summaries (patient ID, root cause, amount, recommended action) for human escalation."
  },
  {
    "id": "q41",
    "scenario": 1,
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "When your agent escalates to a human agent, the human agent reports that they lack sufficient context to continue the resolution effectively. They have to re-ask the client basic questions. What should you implement?",
    "options": [
      {
        "id": "a",
        "text": "Compile a structured handoff summary including client ID, root cause, trade reversal amount, actions taken, and recommended next steps."
      },
      {
        "id": "b",
        "text": "Give the human agent access to the full conversation transcript."
    ...
    "correctAnswer": "a",
    "explanation": "Structured handoff summaries provide human agents with the essential information they need in a quickly digestible format. Full transcripts (B) are too verbose to scan quickly. Natural language summaries (C) may miss critical details. Session state transfer (D) is impractical for human agents.",
    "keyTakeaway": "Compile structured handoff summaries (client ID, root cause, amount, recommended action) for human escalation."
  },
  {
    "id": "q42",
    "scenario": 1,
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "When your agent escalates to a human agent, the human agent reports that they lack sufficient context to continue the resolution effectively. They have to re-ask the shipper basic questions. What should you implement?",
    "options": [
      {
        "id": "a",
        "text": "Compile a structured handoff summary including shipper ID, root cause, reroute fee amount, actions taken, and recommended next steps."
      },
      {
        "id": "b",
        "text": "Give the human agent access to the full conversation transcript."
    ...
    "correctAnswer": "a",
    "explanation": "Structured handoff summaries provide human agents with the essential information they need in a quickly digestible format. Full transcripts (B) are too verbose to scan quickly. Natural language summaries (C) may miss critical details. Session state transfer (D) is impractical for human agents.",
    "keyTakeaway": "Compile structured handoff summaries (shipper ID, root cause, amount, recommended action) for human escalation."
  },
  {
    "id": "q43",
    "scenario": 4,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "b",
        "text": "Have the synthesis agent accumulate all verification needs and batch them to the coordinator at the end."
      },
      {
        "id": "c",
        "text": "Give the synthesis agent access to all web search tools so it can handle any verification need directly."
      },
      {
        "id": "d",
        "text": "Have the web search agent proactively cache extra context around each source during initial research."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Grep — to search file contents for the import statement pattern."
      },
      {
        "id": "b",
        "text": "Glob — to find files matching a naming pattern."
      },
      {
        "id": "c",
        "text": "Read — to load each file and check its imports."
      },
      {
        "id": "d",
        "text": "Bash — to run a shell command that searches for the pattern."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Grep — to search for \"test\" in file contents."
      },
      {
        "id": "b",
        "text": "Glob — to find files matching the pattern **/*.test.tsx."
      },
      {
        "id": "c",
        "text": "Bash — to run find . -name \"*.test.tsx\"."
      },
      {
        "id": "d",
        "text": "Read — to load directory listings."
      }
    ],
    "correctAnswer": "b",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use the community MCP server for standard Jira integration, and build a custom server only for team-specific workflows."
      },
      {
        "id": "b",
        "text": "Build a fully custom MCP server to ensure it covers all team needs from the start."
      },
      {
        "id": "c",
        "text": "Fork the community server and modify it to add team-specific features."
      },
      {
        "id": "d",
        "text": "Use the community server and implement team-specific workflows as Claude Code skills instead."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use Read to load the full file contents, make the modification, then use Write to save the complete file."
      },
      {
        "id": "b",
        "text": "Use Bash to run a sed command for the replacement."
      },
      {
        "id": "c",
        "text": "Expand the Edit target text to include more surrounding context for a unique match."
      },
      {
        "id": "d",
        "text": "Use Grep to find the line number, then use Edit with the line number."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use environment variable expansion in .mcp.json (e.g., ${GITHUB_TOKEN}) and set the token in each developer's environment."
      },
      {
        "id": "b",
        "text": "Hardcode the token directly in .mcp.json since it's a shared configuration."
      },
      {
        "id": "c",
        "text": "Store the token in CLAUDE.md under a \"credentials\" section."
      },
      {
        "id": "d",
        "text": "Configure the token in ~/.claude.json and reference it from .mcp.json."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Return structured error metadata including errorCategory (transient/validation), isRetryable boolean, and a human-readable description for each error type."
      },
      {
        "id": "b",
        "text": "Add error handling instructions to the system prompt explaining which errors to retry."
      },
      {
        "id": "c",
        "text": "Implement client-side retry logic with exponential backoff for all errors."
      },
      {
        "id": "d",
        "text": "Return different HTTP status codes and let the agent interpret them."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Too many tools degrades selection reliability. Restrict each subagent's tools to those relevant to its role."
      },
      {
        "id": "b",
        "text": "The system prompt needs clearer instructions about each agent's role."
      },
      {
        "id": "c",
        "text": "The model is too capable and needs to be downgraded to prevent cross-role usage."
      },
      {
        "id": "d",
        "text": "Add tool_choice: \"auto\" to let the model decide the best tools to use."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "The MCP tool's description doesn't adequately explain its capabilities. Enhance it to detail what it does, what it returns, and why it's better than Grep for specific queries."
      },
      {
        "id": "b",
        "text": "Remove the Grep tool from the agent's allowedTools."
      },
      {
        "id": "c",
        "text": "Add an instruction to the system prompt saying \"always prefer MCP tools over built-in tools.\""
      },
      {
        "id": "d",
        "text": "The agent needs to be explicitly configured to prioritize MCP tools."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Production logs show the agent frequently calls get_patient when users ask about prescriptions (e.g., \"check my prescription #12345\"), instead of calling lookup_prescription. Both tools have minimal descriptions (\"Retrieves patient information\" / \"Retrieves prescription details\") and accept similar identifier formats. What's the most effective first step to improve tool selection reliability?",
    "options": [
      {
        "id": "a",
        "text": "Add few-shot examples to the system prompt demonstrating correct tool selection patterns, with 5-8 examples showing prescription-related queries routing to lookup_prescription."
      },
      {
        "id": "b",
        "text": "Expand each tool's description to include input formats it handles, example queries, edge cases, and boundaries explaining when to use it versus similar tools."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Production logs show the agent frequently calls get_client when users ask about portfolios (e.g., \"check my portfolio #12345\"), instead of calling lookup_portfolio. Both tools have minimal descriptions (\"Retrieves client information\" / \"Retrieves portfolio details\") and accept similar identifier formats. What's the most effective first step to improve tool selection reliability?",
    "options": [
      {
        "id": "a",
        "text": "Add few-shot examples to the system prompt demonstrating correct tool selection patterns, with 5-8 examples showing portfolio-related queries routing to lookup_portfolio."
      },
      {
        "id": "b",
        "text": "Expand each tool's description to include input formats it handles, example queries, edge cases, and boundaries explaining when to use it versus similar tools."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Production logs show the agent frequently calls get_shipper when users ask about freights (e.g., \"check my freight #12345\"), instead of calling lookup_freight. Both tools have minimal descriptions (\"Retrieves shipper information\" / \"Retrieves freight details\") and accept similar identifier formats. What's the most effective first step to improve tool selection reliability?",
    "options": [
      {
        "id": "a",
        "text": "Add few-shot examples to the system prompt demonstrating correct tool selection patterns, with 5-8 examples showing freight-related queries routing to lookup_freight."
      },
      {
        "id": "b",
        "text": "Expand each tool's description to include input formats it handles, example queries, edge cases, and boundaries explaining when to use it versus similar tools."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your MCP tool lookup_prescription returns a generic \"Operation failed\" for both temporary database timeouts and permanent \"prescription not found\" conditions. The agent treats both the same way, retrying \"prescription not found\" errors unnecessarily. How should you fix the error responses?",
    "options": [
      {
        "id": "a",
        "text": "Return structured error metadata including errorCategory (transient/validation), isRetryable boolean, and a human-readable description for each error type."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your MCP tool lookup_portfolio returns a generic \"Operation failed\" for both temporary database timeouts and permanent \"portfolio not found\" conditions. The agent treats both the same way, retrying \"portfolio not found\" errors unnecessarily. How should you fix the error responses?",
    "options": [
      {
        "id": "a",
        "text": "Return structured error metadata including errorCategory (transient/validation), isRetryable boolean, and a human-readable description for each error type."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your MCP tool lookup_freight returns a generic \"Operation failed\" for both temporary database timeouts and permanent \"freight not found\" conditions. The agent treats both the same way, retrying \"freight not found\" errors unnecessarily. How should you fix the error responses?",
    "options": [
      {
        "id": "a",
        "text": "Return structured error metadata including errorCategory (transient/validation), isRetryable boolean, and a human-readable description for each error type."
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "The new member hasn't copied the ~/.claude/CLAUDE.md file to their home directory since user-level configs are not shared via version control."
      },
      {
        "id": "b",
        "text": "Claude Code has a caching issue and needs to be restarted."
      },
      {
        "id": "c",
        "text": "The new member needs to run /memory to load the configuration."
      },
      {
        "id": "d",
        "text": "User-level configurations are automatically synced but require authentication first."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Provide 2-3 concrete input/output examples showing the exact transformation you expect, including cases with optional fields present and absent."
      },
      {
        "id": "b",
        "text": "Add \"be consistent\" and \"follow the exact format\" instructions to the prompt."
      },
      {
        "id": "c",
        "text": "Switch to a different model with better instruction following."
      },
      {
        "id": "d",
        "text": "Break the transformation into smaller steps, processing one field at a time."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "context: fork to run the skill in an isolated sub-agent context"
      },
      {
        "id": "b",
        "text": "max-tokens: 500 to limit the output length"
      },
      {
        "id": "c",
        "text": "mode: silent to suppress the output"
      },
      {
        "id": "d",
        "text": "scope: isolated to separate the skill context"
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "d",
        "text": "Add the --batch flag: claude --batch \"...\""
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Session context isolation: the same session that generated code retains reasoning context, making it less likely to question its own decisions compared to an independent review instance."
      },
      {
        "id": "b",
        "text": "The review prompt needs more detailed criteria for what issues to flag."
      },
      {
        "id": "c",
        "text": "The model needs extended thinking enabled to catch more subtle issues."
      },
      {
        "id": "d",
        "text": "The generated code is already high quality, and human reviewers are overly critical."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Split the monolithic CLAUDE.md into focused topic-specific files in .claude/rules/ (e.g., testing.md, api-conventions.md, deployment.md)."
      },
      {
        "id": "b",
        "text": "Keep the single file but add a table of contents at the top."
      },
      {
        "id": "c",
        "text": "Move less critical sections to a separate README-CONVENTIONS.md file."
      },
      {
        "id": "d",
        "text": "Use markdown headers more aggressively to help Claude navigate the long document."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Provide existing test files in context so test generation avoids suggesting duplicate scenarios already covered by the test suite."
      },
      {
        "id": "b",
        "text": "Add \"don't duplicate existing tests\" to the prompt without providing the existing tests."
      },
      {
        "id": "c",
        "text": "Run a deduplication pass after generation that removes tests similar to existing ones."
      },
      {
        "id": "d",
        "text": "Generate tests in a separate directory and manually merge non-duplicates."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use the interview pattern: have Claude ask questions to surface design considerations you may not have anticipated before implementing."
      },
      {
        "id": "b",
        "text": "Provide a detailed specification and have Claude implement it directly."
      },
      {
        "id": "c",
        "text": "Ask Claude to generate the complete caching system with all possible features enabled."
      },
      {
        "id": "d",
        "text": "Start with a minimal implementation and add features as edge cases are discovered in production."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Include prior review findings in context when re-running, instructing Claude to report only new or still-unaddressed issues."
      },
      {
        "id": "b",
        "text": "Only review the diff between the new commits and the previous review point."
      },
      {
        "id": "c",
        "text": "Cache the previous review output and filter duplicates before posting."
      },
      {
        "id": "d",
        "text": "Skip the re-review and assume previous findings still apply."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Project-level CLAUDE.md with universal standards, plus @import to include package-specific standards files relevant to each package."
      },
      {
        "id": "b",
        "text": "One large CLAUDE.md at the root covering everything for all packages."
      },
      {
        "id": "c",
        "text": "Only package-level CLAUDE.md files with no project-level config."
      },
      {
        "id": "d",
        "text": "A separate repository for CLAUDE.md files that each package references."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "--output-format json with --json-schema to produce machine-parseable structured findings."
      },
      {
        "id": "b",
        "text": "--format json to set the output format."
      },
      {
        "id": "c",
        "text": "-p with a prompt that says \"respond in JSON format.\""
      },
      {
        "id": "d",
        "text": "--structured-output with a schema file path."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Direct execution — the change is simple, well-scoped, and clearly defined."
      },
      {
        "id": "b",
        "text": "Plan mode — to explore potential side effects of the validation change."
      },
      {
        "id": "c",
        "text": "Plan mode — because all code changes should start with planning."
      },
      {
        "id": "d",
        "text": "Direct execution in a forked session — to test the change in isolation."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Address the 2 interacting logic errors together in a single detailed message, then fix the 3 formatting bugs sequentially or in a separate batch."
      },
      {
        "id": "b",
        "text": "Report all 5 issues in one message to maximize efficiency."
      },
      {
        "id": "c",
        "text": "Fix each of the 5 issues one at a time in separate messages."
      },
      {
        "id": "d",
        "text": "Fix the formatting bugs first since they're simpler, then tackle the logic errors."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Temporarily disable the \"comment accuracy\" category to restore trust while you improve those prompts specifically."
      },
      {
        "id": "b",
        "text": "Add \"only report high-confidence findings\" to the system prompt."
      },
      {
        "id": "c",
        "text": "Reduce the overall number of findings reported by raising the severity threshold across all categories."
      },
      {
        "id": "d",
        "text": "Add a confidence score to each finding and let developers filter by confidence level."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Make the \"Purchase Order\" field optional (nullable) in the schema so the model can return null when the information doesn't exist in the source document."
      },
      {
        "id": "b",
        "text": "Add a prompt instruction saying \"Don't make up PO numbers if they're not present.\""
      },
      {
        "id": "c",
        "text": "Add a validation step that cross-references extracted PO numbers against a database."
      },
      {
        "id": "d",
        "text": "Use a separate extraction pass just for PO numbers with a specialized prompt."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Use tool_use with a JSON schema defined in the tool's input_schema, and extract data from the tool_use response."
      },
      {
        "id": "b",
        "text": "Add \"Return valid JSON only. No markdown, no explanation.\" to the prompt."
      },
      {
        "id": "c",
        "text": "Implement a JSON repair library that fixes common syntax errors in the output."
      },
      {
        "id": "d",
        "text": "Use regex to extract the JSON block from the response before parsing."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Identify that retries are ineffective when required information is absent from the source document, and route these cases to human review instead of infinite retry loops."
      },
      {
        "id": "b",
        "text": "Increase the retry count from 3 to 10 to give the model more attempts."
      },
      {
        "id": "c",
        "text": "Add a prompt instruction to \"try harder\" on subsequent retries."
      },
      {
        "id": "d",
        "text": "Lower the validation threshold to accept sums within 10% of the stated total."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Add few-shot examples showing correct extraction from documents with varied formats, including inline citations, methodology sections, and embedded details."
      },
      {
        "id": "b",
        "text": "Create separate extraction prompts for each document type."
      },
      {
        "id": "c",
        "text": "Add a classification step that identifies the document structure before extraction."
      },
      {
        "id": "d",
        "text": "Use regex pre-processing to normalize all documents to a standard format before extraction."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Add an \"other\" enum value paired with a detail string field for the model to describe the actual document type."
      },
      {
        "id": "b",
        "text": "Allow free text instead of an enum to handle any document type."
      },
      {
        "id": "c",
        "text": "Add every possible document type to the enum, including rare ones, to ensure complete coverage."
      },
      {
        "id": "d",
        "text": "Force the model to choose the closest matching predefined type, even if it's not exact."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Set tool_choice: \"any\" to guarantee the model calls a tool, while letting it choose between the invoice and receipt extraction tools based on document content."
      },
      {
        "id": "b",
        "text": "Add \"You must always call a tool. Never respond with text.\" to the system prompt."
      },
      {
        "id": "c",
        "text": "Create a single combined extraction tool that handles both document types."
      },
      {
        "id": "d",
        "text": "Add a classification step before extraction to determine the document type, then force the specific tool."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Refine prompts on the sample set to maximize first-pass success rates before batch-processing the full volume."
      },
      {
        "id": "b",
        "text": "Process all 10,000 immediately and fix errors in a second pass."
      },
      {
        "id": "c",
        "text": "Split the 10,000 into batches of 50 and process each batch with manual review."
      },
      {
        "id": "d",
        "text": "Use a different model for the full batch that has higher accuracy."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Extract both values and add a \"conflict_detected\" boolean flag, letting downstream systems or human reviewers investigate the discrepancy."
      },
      {
        "id": "b",
        "text": "Always use the calculated total since arithmetic is deterministic."
      },
      {
        "id": "c",
        "text": "Always use the stated total since it's the \"source of truth.\""
      },
      {
        "id": "d",
        "text": "Retry the extraction assuming the model misread one of the values."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Include 2-4 few-shot examples showing the exact desired format: file location, issue description, severity level, and suggested fix."
      },
      {
        "id": "b",
        "text": "Use a more detailed prompt with explicit formatting rules and markdown templates."
      },
      {
        "id": "c",
        "text": "Post-process the output with regex to extract structured data from whatever format is returned."
      },
      {
        "id": "d",
        "text": "Use tool_use with a JSON schema to force structured output for each finding."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Resubmit only the 20 failed documents (identified by custom_id) with appropriate modifications like chunking oversized documents."
      },
      {
        "id": "b",
        "text": "Resubmit all 500 documents to ensure consistency."
      },
      {
        "id": "c",
        "text": "Manually process the 20 failed documents."
      },
      {
        "id": "d",
        "text": "Accept 96% success rate and skip the failures."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "c",
        "text": "Keep real-time calls for both workflows to avoid batch result prescriptioning issues."
      },
      {
        "id": "d",
        "text": "Switch both to batch processing with a timeout fallback to real-time if batches take too long."
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "c",
        "text": "Keep real-time calls for both workflows to avoid batch result portfolioing issues."
      },
      {
        "id": "d",
        "text": "Switch both to batch processing with a timeout fallback to real-time if batches take too long."
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "c",
        "text": "Keep real-time calls for both workflows to avoid batch result freighting issues."
      },
      {
        "id": "d",
        "text": "Switch both to batch processing with a timeout fallback to real-time if batches take too long."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "You're building an extraction system that processes invoices. Some invoices have a \"Purchase Prescription\" field and others don't. When you make this field required in the JSON schema, the model fabricates PO numbers for invoices that don't have one. What's the correct schema design?",
    "options": [
      {
        "id": "a",
        "text": "Make the \"Purchase Prescription\" field optional (nullable) in the schema so the model can return null when the information doesn't exist in the source document."
      },
      {
        "id": "b",
        "text": "Add a prompt instruction saying \"Don't make up PO numbers if they're not present.\""
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "You're building an extraction system that processes invoices. Some invoices have a \"Purchase Portfolio\" field and others don't. When you make this field required in the JSON schema, the model fabricates PO numbers for invoices that don't have one. What's the correct schema design?",
    "options": [
      {
        "id": "a",
        "text": "Make the \"Purchase Portfolio\" field optional (nullable) in the schema so the model can return null when the information doesn't exist in the source document."
      },
      {
        "id": "b",
        "text": "Add a prompt instruction saying \"Don't make up PO numbers if they're not present.\""
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "You're building an extraction system that processes invoices. Some invoices have a \"Purchase Freight\" field and others don't. When you make this field required in the JSON schema, the model fabricates PO numbers for invoices that don't have one. What's the correct schema design?",
    "options": [
      {
        "id": "a",
        "text": "Make the \"Purchase Freight\" field optional (nullable) in the schema so the model can return null when the information doesn't exist in the source document."
      },
      {
        "id": "b",
        "text": "Add a prompt instruction saying \"Don't make up PO numbers if they're not present.\""
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Increase the model's max_tokens to allow more room for processing all three issues."
      },
      {
        "id": "b",
        "text": "Extract transactional facts (amounts, dates, order numbers, statuses) into a persistent \"case facts\" block included in each prompt, outside summarized history."
      },
      {
        "id": "c",
        "text": "Process each issue in a separate conversation to prevent cross-contamination."
      },
      {
        "id": "d",
        "text": "Enable extended thinking to give the model more time to track multiple concurrent issues."
      }
    ],
    "correctAnswer": "b",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Report only the more recent figure ($62B) as it's the most current."
      },
      {
        "id": "b",
        "text": "Average the two values and report $53.5B as the estimated market size."
      },
      {
        "id": "c",
        "text": "Include both values with source attribution and note the temporal difference (2023 data vs 2024 projection)."
      },
      {
        "id": "d",
        "text": "Flag the conflict and escalate to a human reviewer to determine the correct value."
      }
    ],
    "correctAnswer": "c",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Spawn subagents to investigate specific questions while the main agent maintains high-level coordination, and have agents record key findings in scratchpad files."
      },
      {
        "id": "b",
        "text": "Restart the conversation every 20 minutes to prevent context degradation."
      },
      {
        "id": "c",
      ...
      {
        "id": "d",
        "text": "Ask the agent to summarize everything it knows at regular intervals to reinforce its memory."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Aggregate accuracy masked poor performance on specific document types. Implement accuracy analysis by document type and field before automating."
      },
      {
        "id": "b",
        "text": "The model degraded over time and needs to be updated to the latest version."
      },
      {
        "id": "c",
        "text": "The confidence threshold was set too low. Raise it from 90% to 99%."
      },
      {
        "id": "d",
        "text": "Medical billing documents should have been excluded from the extraction pipeline entirely."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Require subagents to output structured claim-source mappings (source URLs, document names, relevant excerpts) that the synthesis agent must preserve when combining findings."
      },
      {
        "id": "b",
        "text": "Add footnotes to the report after synthesis, matching claims to a bibliography."
      },
      {
        "id": "c",
        "text": "Have each subagent produce its own mini-report with citations, then concatenate them."
      },
      {
        "id": "d",
        "text": "Ask the synthesis agent to cite its sources more carefully in a follow-up pass."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Honor the explicit request for a human agent immediately without first attempting investigation."
      },
      {
        "id": "b",
        "text": "Explain that the issue is simple and offer to resolve it quickly, escalating only if the customer reiterates their preference."
      },
      {
        "id": "c",
        "text": "Escalate immediately with a structured handoff summary."
      },
      {
        "id": "d",
        "text": "Both A and C — honor the request AND provide the handoff summary."
      }
    ],
    "correctAnswer": "d",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "/compact to reduce context usage by summarizing the conversation."
      },
      {
        "id": "b",
        "text": "/clear to delete the conversation history."
      },
      {
        "id": "c",
        "text": "/reset to start a fresh session with no context."
      },
      {
        "id": "d",
        "text": "/trim to remove old messages from the context."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Escalate because the policy is ambiguous or silent on the customer's specific request—policy gaps require human judgment."
      },
      {
        "id": "b",
        "text": "Deny the request since the policy doesn't explicitly mention competitor price matching."
      },
      {
        "id": "c",
        "text": "Approve the price match since the policy mentions price adjustments generally."
      },
      {
        "id": "d",
        "text": "Ask the customer to provide proof of the competitor's price before making a decision."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Modify upstream agents to return structured data (key facts, citations, relevance scores) instead of verbose content and reasoning chains."
      },
      {
        "id": "b",
        "text": "Increase the synthesis agent's context window size."
      },
      {
        "id": "c",
        "text": "Have the synthesis agent process one subagent output at a time."
      },
      {
        "id": "d",
        "text": "Add a summarization step between each subagent and the synthesis agent."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Trim verbose tool outputs to only relevant fields before they accumulate in context (e.g., keep only return-relevant fields from customer lookups)."
      },
      {
        "id": "b",
        "text": "Modify the get_customer tool to return fewer fields by default."
      },
      {
        "id": "c",
        "text": "Increase the model's context window to accommodate the verbose outputs."
      },
      {
        "id": "d",
        "text": "Don't worry about it — the model handles large contexts efficiently."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "The subagent doesn't distinguish between access failures (search engine timeout) and valid empty results (successful query, no matches). It should use different response formats for each."
      },
      {
        "id": "b",
        "text": "The coordinator needs better retry logic to detect repeated empty results."
      },
      {
        "id": "c",
        "text": "The search query needs to be broader to avoid zero-result queries."
      },
      {
        "id": "d",
        "text": "Empty results should always trigger a retry with modified search terms."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Design structured agent state exports (manifests) where each agent saves its state to a known location, and the coordinator loads the manifest on resume to inject prior findings into agent prompts."
      },
      {
        "id": "b",
        "text": "Implement database-backed state management with full transaction logging."
      },
      {
        "id": "c",
        "text": "Run all subagents again from scratch since cached state may be stale."
      },
      {
        "id": "d",
        "text": "Use checkpointing in the coordinator to save conversation state at regular intervals."
      }
    ],
    "correctAnswer": "a",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "d",
        "text": "Implement sentiment analysis to detect patient frustration levels and automatically escalate when negative sentiment exceeds a threshold."
      }
    ],
    "correctAnswer": "a",
    "explanation": "Adding explicit escalation criteria with few-shot examples directly addresses the root cause: unclear decision boundaries. This is the proportionate first response before adding infrastructure. Option B fails because LLM self-reported confidence is poorly calibrated. Option C is over-engineered, requiring labeled data and ML infrastructure when prompt optimization hasn't been tried. Option D solves a different problem entirely; sentiment doesn't correlate with case complexity.",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "d",
        "text": "Implement sentiment analysis to detect client frustration levels and automatically escalate when negative sentiment exceeds a threshold."
      }
    ],
    "correctAnswer": "a",
    "explanation": "Adding explicit escalation criteria with few-shot examples directly addresses the root cause: unclear decision boundaries. This is the proportionate first response before adding infrastructure. Option B fails because LLM self-reported confidence is poorly calibrated. Option C is over-engineered, requiring labeled data and ML infrastructure when prompt optimization hasn't been tried. Option D solves a different problem entirely; sentiment doesn't correlate with case complexity.",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "d",
        "text": "Implement sentiment analysis to detect shipper frustration levels and automatically escalate when negative sentiment exceeds a threshold."
      }
    ],
    "correctAnswer": "a",
    "explanation": "Adding explicit escalation criteria with few-shot examples directly addresses the root cause: unclear decision boundaries. This is the proportionate first response before adding infrastructure. Option B fails because LLM self-reported confidence is poorly calibrated. Option C is over-engineered, requiring labeled data and ML infrastructure when prompt optimization hasn't been tried. Option D solves a different problem entirely; sentiment doesn't correlate with case complexity.",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "During a complex patient interaction involving three separate prescription issues, your agent correctly identifies all problems initially but by the third issue, it contradicts its earlier findings about the first issue's claim adjustment amount ($47.99 vs the correct $42.99). What's the most effective mitigation strategy?",
    "options": [
      {
        "id": "a",
        "text": "Increase the model's max_tokens to allow more room for processing all three issues."
      ...
      {
        "id": "b",
        "text": "Extract transactional facts (amounts, dates, prescription numbers, statuses) into a persistent \"case facts\" block included in each prompt, outside summarized history."
      },
      {
        "id": "c",
        "text": "Process each issue in a separate conversation to prevent cross-contamination."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "During a complex client interaction involving three separate portfolio issues, your agent correctly identifies all problems initially but by the third issue, it contradicts its earlier findings about the first issue's trade reversal amount ($47.99 vs the correct $42.99). What's the most effective mitigation strategy?",
    "options": [
      {
        "id": "a",
        "text": "Increase the model's max_tokens to allow more room for processing all three issues."
      ...
      {
        "id": "b",
        "text": "Extract transactional facts (amounts, dates, portfolio numbers, statuses) into a persistent \"case facts\" block included in each prompt, outside summarized history."
      },
      {
        "id": "c",
        "text": "Process each issue in a separate conversation to prevent cross-contamination."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "During a complex shipper interaction involving three separate freight issues, your agent correctly identifies all problems initially but by the third issue, it contradicts its earlier findings about the first issue's reroute fee amount ($47.99 vs the correct $42.99). What's the most effective mitigation strategy?",
    "options": [
      {
        "id": "a",
        "text": "Increase the model's max_tokens to allow more room for processing all three issues."
      ...
      {
        "id": "b",
        "text": "Extract transactional facts (amounts, dates, freight numbers, statuses) into a persistent \"case facts\" block included in each prompt, outside summarized history."
      },
      {
        "id": "c",
        "text": "Process each issue in a separate conversation to prevent cross-contamination."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A frustrated patient says \"I want to speak with a real person\" after the agent has correctly identified a simple issue (a standard return within policy). How should the agent respond?",
    "options": [
      {
        "id": "a",
        "text": "Honor the explicit request for a human agent immediately without first attempting investigation."
      ...
      {
        "id": "b",
        "text": "Explain that the issue is simple and offer to resolve it quickly, escalating only if the patient reiterates their preference."
      },
      {
        "id": "c",
        "text": "Escalate immediately with a structured handoff summary."
    ...
    "correctAnswer": "d",
    "explanation": "When a patient explicitly requests a human agent, honor that request immediately (A). AND compile a structured handoff summary (C) so the human agent has the context. The correct approach combines both actions: immediate escalation with complete context handoff.",
    "keyTakeaway": "Honor explicit requests for human agents immediately. Always include structured handoff summaries."
  },
  {
    "id": "q241",
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A frustrated client says \"I want to speak with a real person\" after the agent has correctly identified a simple issue (a standard return within policy). How should the agent respond?",
    "options": [
      {
        "id": "a",
        "text": "Honor the explicit request for a human agent immediately without first attempting investigation."
      ...
      {
        "id": "b",
        "text": "Explain that the issue is simple and offer to resolve it quickly, escalating only if the client reiterates their preference."
      },
      {
        "id": "c",
        "text": "Escalate immediately with a structured handoff summary."
    ...
    "correctAnswer": "d",
    "explanation": "When a client explicitly requests a human agent, honor that request immediately (A). AND compile a structured handoff summary (C) so the human agent has the context. The correct approach combines both actions: immediate escalation with complete context handoff.",
    "keyTakeaway": "Honor explicit requests for human agents immediately. Always include structured handoff summaries."
  },
  {
    "id": "q242",
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "A frustrated shipper says \"I want to speak with a real person\" after the agent has correctly identified a simple issue (a standard return within policy). How should the agent respond?",
    "options": [
      {
        "id": "a",
        "text": "Honor the explicit request for a human agent immediately without first attempting investigation."
      ...
      {
        "id": "b",
        "text": "Explain that the issue is simple and offer to resolve it quickly, escalating only if the shipper reiterates their preference."
      },
      {
        "id": "c",
        "text": "Escalate immediately with a structured handoff summary."
    ...
    "correctAnswer": "d",
    "explanation": "When a shipper explicitly requests a human agent, honor that request immediately (A). AND compile a structured handoff summary (C) so the human agent has the context. The correct approach combines both actions: immediate escalation with complete context handoff.",
    "keyTakeaway": "Honor explicit requests for human agents immediately. Always include structured handoff summaries."
  },
  {
    "id": "q243",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "A patient asks for a competitor price match. Your company's policy mentions price adjustments for own-site discrepancies but is silent on competitor price matching. What should the agent do?",
    "options": [
      {
        "id": "a",
        "text": "Escalate because the policy is ambiguous or silent on the patient's specific request—policy gaps require human judgment."
      },
      {
        "id": "b",
        "text": "Deny the request since the policy doesn't explicitly mention competitor price matching."
      ...
      {
        "id": "d",
        "text": "Ask the patient to provide proof of the competitor's price before making a decision."
      }
    ],
    "correctAnswer": "a",
    "explanation": "When policy is ambiguous or silent on a patient's specific request, the agent should escalate. Policy gaps require human judgment—the agent shouldn't deny or approve based on inference. Asking for proof (D) implies the agent has authority to approve, which it doesn't when policy is unclear.",
    "keyTakeaway": "Escalate when policy is ambiguous or silent on the request. Policy gaps need human judgment."
  },
  {
    "id": "q247",
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "A client asks for a competitor price match. Your company's policy mentions price adjustments for own-site discrepancies but is silent on competitor price matching. What should the agent do?",
    "options": [
      {
        "id": "a",
        "text": "Escalate because the policy is ambiguous or silent on the client's specific request—policy gaps require human judgment."
      },
      {
        "id": "b",
        "text": "Deny the request since the policy doesn't explicitly mention competitor price matching."
      ...
      {
        "id": "d",
        "text": "Ask the client to provide proof of the competitor's price before making a decision."
      }
    ],
    "correctAnswer": "a",
    "explanation": "When policy is ambiguous or silent on a client's specific request, the agent should escalate. Policy gaps require human judgment—the agent shouldn't deny or approve based on inference. Asking for proof (D) implies the agent has authority to approve, which it doesn't when policy is unclear.",
    "keyTakeaway": "Escalate when policy is ambiguous or silent on the request. Policy gaps need human judgment."
  },
  {
    "id": "q248",
    ...
    "type": "single",
    "difficulty": "hard",
    "question": "A shipper asks for a competitor price match. Your company's policy mentions price adjustments for own-site discrepancies but is silent on competitor price matching. What should the agent do?",
    "options": [
      {
        "id": "a",
        "text": "Escalate because the policy is ambiguous or silent on the shipper's specific request—policy gaps require human judgment."
      },
      {
        "id": "b",
        "text": "Deny the request since the policy doesn't explicitly mention competitor price matching."
      ...
      {
        "id": "d",
        "text": "Ask the shipper to provide proof of the competitor's price before making a decision."
      }
    ],
    "correctAnswer": "a",
    "explanation": "When policy is ambiguous or silent on a shipper's specific request, the agent should escalate. Policy gaps require human judgment—the agent shouldn't deny or approve based on inference. Asking for proof (D) implies the agent has authority to approve, which it doesn't when policy is unclear.",
    "keyTakeaway": "Escalate when policy is ambiguous or silent on the request. Policy gaps need human judgment."
  },
  {
    "id": "q249",
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your agent calls get_patient which returns 40+ fields (name, address, phone, email, loyalty_status, signup_date, last_login, preferences, payment_methods, etc.). For most support interactions, only 5 fields are relevant. These verbose responses accumulate in context over a multi-turn conversation. What should you do?",
    "options": [
      {
        "id": "a",
        "text": "Trim verbose tool outputs to only relevant fields before they accumulate in context (e.g., keep only return-relevant fields from patient lookups)."
      },
      {
        "id": "b",
        "text": "Modify the get_patient tool to return fewer fields by default."
      },
      {
        "id": "c",
        "text": "Increase the model's context window to accommodate the verbose outputs."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your agent calls get_client which returns 40+ fields (name, address, phone, email, loyalty_status, signup_date, last_login, preferences, payment_methods, etc.). For most support interactions, only 5 fields are relevant. These verbose responses accumulate in context over a multi-turn conversation. What should you do?",
    "options": [
      {
        "id": "a",
        "text": "Trim verbose tool outputs to only relevant fields before they accumulate in context (e.g., keep only return-relevant fields from client lookups)."
      },
      {
        "id": "b",
        "text": "Modify the get_client tool to return fewer fields by default."
      },
      {
        "id": "c",
        "text": "Increase the model's context window to accommodate the verbose outputs."
  ...
  },
  {
    ...
    "type": "single",
    "difficulty": "medium",
    "question": "Your agent calls get_shipper which returns 40+ fields (name, address, phone, email, loyalty_status, signup_date, last_login, preferences, payment_methods, etc.). For most support interactions, only 5 fields are relevant. These verbose responses accumulate in context over a multi-turn conversation. What should you do?",
    "options": [
      {
        "id": "a",
        "text": "Trim verbose tool outputs to only relevant fields before they accumulate in context (e.g., keep only return-relevant fields from shipper lookups)."
      },
      {
        "id": "b",
        "text": "Modify the get_shipper tool to return fewer fields by default."
      },
      {
        "id": "c",
        "text": "Increase the model's context window to accommodate the verbose outputs."
